...
def construct_message(account_name,user_slack_details,user_email_details,user_zapier_details,message,req_json,message_variables,system_require,message_detail,mongo):
    ...
    if message_detail['for_slack'] is True:
        slack_notification(user_slack_details,message,message_detail,message_variables,system_require,system_variable,mongo)
    else:
        pass
    ...
    if message_detail['for_email'] is True:
        email_notification(account_name,user_email_details,message,message_detail,message_variables,system_require,system_variable,mongo)
    else:
        pass
    ...
    if 'for_zapier' in message_detail:
        if message_detail['for_zapier'] is True:
            zapier_notification(user_zapier_details,message,message_detail,message_variables,system_require,system_variable,mongo)
        else:
            pass
