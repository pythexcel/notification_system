...
def construct_message(user_slack_details,user_email_details,user_zapier_details,message,req_json,message_variables,system_require,message_detail,mongo):
    ...
    if message_detail['for_email'] is True:
        email_notification(user_email_details,message,message_detail,message_variables,system_require,system_variable,mongo)
    else:
        pass
