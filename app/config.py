...
slack_redirect_url = 'https://app.slack.com/client'   #redirect to slack url
oauth_url = "https://slack.com/api/oauth.v2.access?code={{code}}&client_id={{client_id}}&client_secret={{client_secret}}&redirect_uri={{redirect_uri}}&pretty=1" #Authentication api url
client_id = '124720392913.1224927080886'          #Client id you will get from https://api.slack.com/apps/ url
client_secret = '3436211114f123d5f4efc492b3f0c4ab' #client secret id you will get https://api.slack.com/apps/ url
base_url = 'https://sleepy-badlands-60688.herokuapp.com/'   #in this url ip and port will be server domain.
